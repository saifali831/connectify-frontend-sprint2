...
export default function Login(props) {
    ...
    const handleLogin=()=>{
        ...
        axios.post("https://connectify-backend-sprint2.herokuapp.com/api/user/login",
        {email,password})
        .then(result=>{
        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-md-6 col-lg-6">
                    <h3 className="main-heading">Connecting people with similar thoughts</h3>
                    <p className="primary-text">Share what you thinking, May be someone out there find it useful!</p>
                    <img src={bgImg} className="bg-img" alt="image"/>
                </div>
                <div className="col-12 col-md-6 col-lg-6">
